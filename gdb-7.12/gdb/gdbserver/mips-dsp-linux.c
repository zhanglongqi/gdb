...
static struct reg regs_mips_dsp_linux[] = {
  { "r0", 0, 32 },
  { "r1", 32, 32 },
  { "r2", 64, 32 },
  { "r3", 96, 32 },
...
init_registers_mips_dsp_linux (void)
{
  ...
  result->reg_defs = regs_mips_dsp_linux;
  result->num_registers = sizeof (regs_mips_dsp_linux) / sizeof (regs_mips_dsp_linux[0]);
  result->expedite_regs = expedite_regs_mips_dsp_linux;
